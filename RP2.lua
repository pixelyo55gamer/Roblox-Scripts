...
if game.PlaceId == 5967514178 then --Ready Player 2
    ...
    lplr.Character.Humanoid.WalkSpeed = 64
elseif game.PlaceId == 5661005779 then --Piggy Book 2
    ...
    loadstring(game:HttpGet("https://raw.githubusercontent.com/pixelyo55gamer/script/main/PiggyRP2.lua", true))()
...
elseif game.PlaceId == 1537690962 then --Bee Swarm Simulator
    repeat wait() until game:IsLoaded()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/pixelyo55gamer/script/main/beeswarmrp2.lua", true))()
elseif game.PlaceId == 447452406 then --Robloxian Highschool
    repeat wait() until game:IsLoaded()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/pixelyo55gamer/script/main/RHS.lua", true))()
    wait(0.5)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/CMD-X/CMD-X/master/Source", true))()
elseif game.PlaceId == 5913871729 then --Bad Business Fight
    repeat wait() until game:IsLoaded()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/pixelyo55gamer/script/main/Bad_Business_Script.lua", true))()
elseif game.PlaceId == 2414851778 then --Dungeon Quest
    repeat wait() until game:IsLoaded()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/pixelyo55gamer/script/main/DungeonQuestRp2.lua", true))()
elseif game.PlaceId == 171391948 then --Vehicle Simulator 2
    repeat wait() until game:IsLoaded()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/pixelyo55gamer/script/main/VehicleSimRp2.lua", true))()
    wait(1)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/CMD-X/CMD-X/master/Source", true))()
